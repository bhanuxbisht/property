        ...
        <div className="glass-nav pointer-events-auto relative mx-auto flex w-full max-w-5xl items-center justify-between rounded-full px-5 py-2.5 sm:px-7 sm:py-3">
          ...
          <div className="flex items-center gap-1 sm:gap-3">
            ...
            <a
              ...
              className="btn-peach hidden sm:inline-flex items-center gap-1.5 rounded-full px-4 py-1.5 sm:px-5 sm:py-2 text-xs sm:text-[13.5px] font-semibold text-[#2D2824] shadow-sm transition-all hover:scale-[1.02]"
            >
              <Phone size={14} />
